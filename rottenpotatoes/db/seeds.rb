...
movies = [{:title => 'Aladdin', :rating => 'G',:director => 'Guy Ritchie', :release_date => '25-Nov-1992'},
    	  ...
    	  {:title => 'When Harry Met Sally',:director => 'Rob Seiner', :rating => 'R', :release_date => '21-Jul-1989'},
      	  ...
      	  {:title => 'Jaws', :rating => 'PG', :director => 'Steven Spielberg', :release_date => '20-June-1975'},
  	 ]
